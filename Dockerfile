...
COPY v153-regional-theme.mjs /app/v153-regional-theme.mjs
RUN node /app/v153-regional-theme.mjs && rm /app/v153-regional-theme.mjs
RUN node --check /app/public/v153-regional-theme.js \
 && grep -q '/v153-regional-theme.css' /app/public/index.html \
 && grep -q '/v153-regional-theme.js' /app/public/index.html \
...
COPY v162-clean-photo.mjs /app/v162-clean-photo.mjs
RUN node /app/v162-clean-photo.mjs && rm /app/v162-clean-photo.mjs
RUN node --check /app/public/v162-clean-photo.js \
 && node --check /app/public/service-worker.js \
 && grep -q '/v162-clean-photo.css' /app/public/index.html \
 && grep -q '/v162-clean-photo.js' /app/public/index.html \
 && grep -q '/v162-clean-photo.css' /app/public/transparencia.html \
 && grep -q '/v162-clean-photo.js' /app/public/transparencia.html \
...
RUN node --check /app/server.mjs \
 ...
 COPY v178-backup.mjs /app/v178-backup.mjs
RUN node /app/v178-backup.mjs && rm /app/v178-backup.mjs
RUN node --check /app/server.mjs \
 && node --check /app/public/v178-backup.js \
 && node --check /app/public/service-worker.js \
 && grep -q '/v178-backup.css' /app/public/admin/index.html \
 && grep -q '/v178-backup.js' /app/public/admin/index.html \
 && grep -q "p === '/api/admin/backups'" /app/server.mjs \
 && grep -q "const VERSION='v1.7.8-unified'" /app/public/service-worker.js
 COPY v179-emergency-restore.mjs /app/v179-emergency-restore.mjs
RUN node /app/v179-emergency-restore.mjs && rm /app/v179-emergency-restore.mjs
RUN node --check /app/server.mjs \
 && node --check /app/public/v179-restore.js \
 && node --check /app/public/service-worker.js \
 && grep -q '/v179-restore.css' /app/public/admin/index.html \
 && grep -q '/v179-restore.js' /app/public/admin/index.html \
