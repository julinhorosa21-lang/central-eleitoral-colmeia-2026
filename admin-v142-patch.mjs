...
html = html
  .replace('href="/admin.webmanifest"', 'href="/admin/admin.webmanifest?v=143"')
  .replace('href="/admin.css"', 'href="/admin/admin.css?v=143"')
  .replace('src="/admin.js"', 'src="/admin/admin.js?v=143"');
...
html = html.replace('<button id="installBtn" class="btn light" type="button">Instalar app</button>', '<button id="installBtn" class="btn light install-ready" type="button">Instalar app</button>');
...
css += `
/* V1.4.3 — central administrativa isolada e refinada */
