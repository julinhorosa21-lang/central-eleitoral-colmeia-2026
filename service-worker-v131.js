...
const CORE=[
  '/', '/index.html','/transparencia.html','/operacao.html','/seguranca.html','/admin.html','/manifest.webmanifest','/admin.webmanifest','/admin.css','/admin.js','/bu-parser.js',
